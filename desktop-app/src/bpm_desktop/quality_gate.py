"""Quality gate evaluation for publish batches based on configurable thresholds."""
...
class QualityGateResult:
    """Outcome of a quality gate evaluation with pass/fail, reasons, and computed metrics."""
    passed: bool
    reasons: list[str]
...
def evaluate_quality_gate(metrics: dict[str, Any], thresholds: dict[str, float] | None = None) -> QualityGateResult:
    """Evaluate batch metrics against quality thresholds and return pass/fail with reasons."""
