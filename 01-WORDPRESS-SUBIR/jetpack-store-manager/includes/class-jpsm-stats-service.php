...
class JPSM_Stats_Service
{
    ...
    private static function get_folder_download_stats($limit = 30)
    {
        ...
        if (class_exists('JPSM_Data_Layer')) {
            $rows = JPSM_Data_Layer::get_top_folder_downloads($limit);
            $totals = JPSM_Data_Layer::get_folder_download_totals();
        }
    ...
    private static function get_behavior_report_stats()
    {
        ...
        return JPSM_Behavior_Service::get_dashboard_behavior_report(current_time('Y-m'), array(
            'tier' => 'all',
            'region' => 'all',
            'device_class' => 'all',
        ));
    ...
    private static function get_transfer_report_stats()
    {
        ...
        return JPSM_Behavior_Service::get_dashboard_transfer_report(current_time('Y-m'), array(
            'tier' => 'all',
            'region' => 'all',
            'device_class' => 'all',
        ));
