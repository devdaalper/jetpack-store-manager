...
class ComposerStaticInit4f197e466595a6ddf001a54b789943f3
{
    ...
    public static $classMap = array (
        ...
        'JetpackStore\\API_Contract' => __DIR__ . '/../..' . '/includes/class-jpsm-api-contract.php',
        'JetpackStore\\Access_Manager' => __DIR__ . '/../..' . '/includes/class-access-manager.php',
        'JetpackStore\\Access_Service' => __DIR__ . '/../..' . '/includes/class-jpsm-access-service.php',
        'JetpackStore\\Admin' => __DIR__ . '/../..' . '/includes/class-jpsm-admin.php',
        'JetpackStore\\Admin_Views' => __DIR__ . '/../..' . '/includes/class-jpsm-admin-views.php',
        'JetpackStore\\Auth' => __DIR__ . '/../..' . '/includes/class-jpsm-auth.php',
        'JetpackStore\\Behavior_Service' => __DIR__ . '/../..' . '/includes/class-jpsm-behavior-service.php',
        'JetpackStore\\Config' => __DIR__ . '/../..' . '/includes/class-jpsm-config.php',
        'JetpackStore\\Dashboard' => __DIR__ . '/../..' . '/includes/class-jpsm-dashboard.php',
        'JetpackStore\\Data_Layer' => __DIR__ . '/../..' . '/includes/class-jpsm-data-layer.php',
        'JetpackStore\\Domain_Model' => __DIR__ . '/../..' . '/includes/class-jpsm-domain-model.php',
        'JetpackStore\\Finance' => __DIR__ . '/../..' . '/includes/class-jpsm-finance.php',
        'JetpackStore\\MediaVault\\Index_Manager' => __DIR__ . '/../..' . '/includes/modules/mediavault/class-index-manager.php',
        'JetpackStore\\MediaVault\\Nav_Order' => __DIR__ . '/../..' . '/includes/modules/mediavault/class-nav-order.php',
        'JetpackStore\\MediaVault\\S3_Client' => __DIR__ . '/../..' . '/includes/modules/mediavault/class-s3-client.php',
        'JetpackStore\\MediaVault\\Traffic_Manager' => __DIR__ . '/../..' . '/includes/modules/mediavault/class-traffic-manager.php',
        'JetpackStore\\MediaVault\\UI' => __DIR__ . '/../..' . '/includes/modules/mediavault/template-vault.php',
        'JetpackStore\\REST' => __DIR__ . '/../..' . '/includes/class-jpsm-rest.php',
        'JetpackStore\\Sales' => __DIR__ . '/../..' . '/includes/class-jpsm-sales.php',
        'JetpackStore\\Stats_Service' => __DIR__ . '/../..' . '/includes/class-jpsm-stats-service.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit4f197e466595a6ddf001a54b789943f3::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit4f197e466595a6ddf001a54b789943f3::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit4f197e466595a6ddf001a54b789943f3::$classMap;
