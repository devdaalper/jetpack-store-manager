...
class S3_Client
{
     ...
     *
     * @param string $access_key B2 application key ID.
     * @param string $secret_key B2 application key.
     * @param string $region     B2 bucket region (e.g. us-west-004).
     ...
     * @return array|WP_Error Array with 'folders' and 'files' keys, or WP_Error on failure.
     */
    ...
    /**
     * Enable CORS on the bucket to allow browser fetch() requests.
     *
     * @return array|WP_Error WordPress HTTP API response or WP_Error on failure.
     */
     ...
     * @return array|WP_Error Flat array of file arrays (path, name, size), or WP_Error on failure.
     */
...
class_alias(S3_Client::class, 'JPSM_S3_Client');
