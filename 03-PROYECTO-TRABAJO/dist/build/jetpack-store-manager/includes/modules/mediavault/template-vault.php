...
class JPSM_MediaVault_UI
{
    ...
    public static function handle_ajax()
    {
        ...
        if (isset($_GET['action']) && $_GET['action'] === 'mv_stream_preview') {
            ...
            if (!function_exists('curl_init')) {
                ...
                echo (string) wp_remote_retrieve_body($res);
                exit;
            }
    ...
    public static function render()
    {
                    ...
                    ">
                        ...
                        if ($mv_whatsapp_banner !== '') {
                            ...
                            if (is_email($admin_email)) {
                                $banner_href = 'mailto:' . $admin_email . '?subject=' . rawurlencode('Solicitud de acceso completo') . '&body=' . rawurlencode($banner_msg);
                            }
                        }
                        ?>
                        <?php if ($banner_href !== ''): ?>
        ...
        $mv_admin_email = (string) get_option('admin_email', '');
        ?>
	        <?php
